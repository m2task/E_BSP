...
export function setField(newField) {
    field = newField;
}
export function setHand(newHand) {
    hand = newHand;
}
export function setTrash(newTrash) {
    trash = newTrash;
}
export function setBurst(newBurst) {
    burst = newBurst;
}
export function setLifeCores(newLifeCores) {
    lifeCores = newLifeCores;
}
export function setReserveCores(newReserveCores) {
    reserveCores = newReserveCores;
}
export function setDeckCores(newDeckCores) {
    deckCores = newDeckCores;
}
export function setTrashCores(newTrashCores) {
    trashCores = newTrashCores;
}
export function setVoidChargeCount(count) {
    voidChargeCount = count;
}
export function setToastTimeout(timeout) {
    toastTimeout = timeout;
}
export function setHandVisible(visible) {
    handVisible = visible;
}
export function setDeckShowCountAsNumber(showAsNumber) {
    deckShowCountAsNumber = showAsNumber;
}
export function setCardIdCounter(counter) {
    cardIdCounter = counter;
}
...
export function setCardPositions(positions) {
    cardPositions = positions;
}
export function setSelectedCores(cores) {
    selectedCores = cores;
}
export function setDraggedCoreData(data) {
    draggedCoreData = data;
}