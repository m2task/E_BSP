...
import { handleCoreClick, clearSelectedCores, handleCoreDropOnCard, handleCoreInternalMoveOnCard, handleCoreDropOnZone, payCost, payCostFromField, cancelPayment, moveCoreFromField, cancelCoreMove, placeCoreOnSummonedCard, moveSelectedCoresToCard } from './core_logic.js';
...
export function setupEventListeners() {
    ...
    // ブラシ選択のイベントリスナー
    document.addEventListener('mousedown', handleBrushMouseDown);
}
